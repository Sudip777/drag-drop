...
interface DragTarget {
  dragOverHandler(event: DragEvent): void //signal that valid drag target
  dropHandler(event: DragEvent): void //permits drop
  dragLeaveHandler(event: DragEvent): void //visual feedback
}
...
extends Component<
    ...
    HTMLLIElement
  >
  implements Draggable //interface implementation
{
  private project: Project

  get persons() { //correcting person/persons
  ...
  renderContent() { // template:single-project
...
//==========ProjectList Class: renders list of project=========
class ProjectList
  ...
  implements DragTarget
{
  ...
  @autobind //make sure this is bound to surrounding class
  dragOverHandler(event: DragEvent) { //change apperance of ul
    if (
      event.dataTransfer &&
      ...
      const listEl =
        this.element.querySelector("ul")! //reacing ul
      listEl.classList.add("droppable") // VJS
    }
  }
